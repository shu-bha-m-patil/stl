...
int GetConnectedGraphCount(std::vector<int>* adjList, int v)
{
    //bool visited[v + 1];
...
int main()
{
    ...
    int disconnectedGraphCount =  GetConnectedGraphCount(adjList, v);
    std::cout << "The no of connected Graph is " << disconnectedGraphCount << std::endl;
